...
import { Fingerprint, Shield, Upload, Lock } from 'lucide-react'
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 via-purple-600/10 to-teal-600/10 animate-gradient" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold mb-3 bg-gradient-to-r from-blue-400 via-purple-400 to-teal-400 bg-clip-text text-transparent">
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-teal-500 text-white py-3 px-6 rounded-lg font-semibold hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg hover:shadow-xl"
            >
              {loading ? (
